...
export const success = [
  {
    "page": (
      <div key="sequence-01" className="dialogue-container">
        ...
        <p>
          ยอดเยี่ยม! พวกท่านได้ไขปริศนาสำเร็จแล้ว! อาณาจักรจะรอดพ้นจากหายนะแล้ว!
        </p>
      </div>
    ),
    "cooldown": false
  },
  {
    "page": (
      <div key="sequence-02" className="dialogue-container">
        ...
        <p>
          คุณได้รับรางวัลจากเทวีฮิปโปเป็นชิ้นส่วนปริศนา!
        </p>
      </div>
    ),
    "cooldown": false
    ...
    "page": (
      <div key="sequence-04" className="dialogue-container">
        ...
        <p className="text-6xl font-bold animate-fade [animation-delay:500ms] opacity-0 [animation-fill-mode:forwards]">
          {typeof window !== 'undefined' ? (`${validJigsaw[parseInt(localStorage.getItem("sktd-ske2024-room03-randomJigsawIndex"))][1]}`) : ''}
        </p>
        <p>แล้ว!!</p>
      </div>
    ),
